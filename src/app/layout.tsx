...
const siteUrl =
  process.env.NEXT_PUBLIC_SITE_URL || "https://supratikch.vercel.app";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Supratik Chakraborty - Full-Stack Software Engineer specializing in Enterprise SaaS & AI Solutions",
        type: "image/png",
      },
    ],
  },
